...
const Cart = () => {
  ...
  const myStyle = {
    backgroundImage: `url(${"/img/bbb.png"})`,
  ...
  console.log(open);
  return open ? (
    <div className={`w-full md:h-[100vh] py-10  relative`} style={myStyle}>
      <div className="max-w-[1340px] mx-auto pb-20 ">
        <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-2">
          <div className="col-span-2">
            ...
            {cart.length === 0 && (
              <>
                <h3 className="text-center py-3 font-bold text-red-500 text-4xl">
                  NO CARTS YET
                </h3>
                <Link to="/products">
    ...
    <div className={`w-full md:h-[100vh] py-10  relative`}>
      <div className="max-w-[1340px] mx-auto pb-20 ">
        <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-2">
          <div className="col-span-2">
            <div className="flex relative py-10 mt-5 shadow-xl w-full h-20   ">
